...
# define a TemperatureConverter class that has two static methods
...
# A UI to show the converting temperature from Fahreneit to Celcius and vice versa
class ConverterFrame(ttk.Frame):
    ...
    def reset(self):
        """This clears the entry widget and result label when the frame is switched from one to another"""
